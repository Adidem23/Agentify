  ...
  return (
    <>
      <Card>
        ...
        <CardTitle>Database Agents</CardTitle>
        <CardDescription>
          Explore databases with ease! Our database card provides a user-friendly interface for managing and querying your data. Whether you're a developer or a data analyst, this card has everything you need to get started.
        </CardDescription>
        <br />
        <motion.button
  ...
  return (
    <>
      <Card>
        ...
        <CardTitle>Gmail Agents</CardTitle>
        <CardDescription>
...
export function CodeDebuggerCardDemo() {
  return (
    <>
      <Card>
        <CardSkeletonContainer>
        ...
        <CardTitle>CodeDebugger Agents</CardTitle>
        <CardDescription>
          Debug your code like a pro! Our CodeDebugger card provides advanced debugging tools and features to help you identify and fix issues in your code quickly. Perfect for developers looking to streamline their workflow.
        </CardDescription>
        <br />
        <motion.button
          whileHover={{ scale: 1.05 }}
...
export function GithubDemoCards() {
  return (
    <>
      <Card>
        <CardSkeletonContainer>
        ...
        <CardTitle>Github Agents</CardTitle>
        <CardDescription>
          Manage your code repositories with ease! Our Github card provides a powerful interface for managing your projects, issues, and pull requests. Perfect for developers looking to streamline their workflow and collaborate with others.
        </CardDescription>
        <br />
        <motion.button
          whileHover={{ scale: 1.05 }}
...
export function TicketingAgentsCardDemo() {
  return (
    <>
      <Card>
        <CardSkeletonContainer>
        ...
        <CardTitle>Ticketing Agents</CardTitle>
        <CardDescription>
          Streamline your support process! Our ticketing agents card provides a comprehensive solution for managing customer inquiries and support requests. With features like ticket tracking, automated responses, and reporting, you'll never miss a beat.
        </CardDescription>
        <br />
        <motion.button
          whileHover={{ scale: 1.05 }}
